...
[![Django CI](https://github.com/jambo-park/system/actions/workflows/django.yml/badge.svg)](.github/workflows/django.yml)
[![Flutter CI](https://github.com/jambo-park/system/actions/workflows/flutter.yml/badge.svg)](.github/workflows/flutter.yml)
...
*   📱 **[User Application](parking_user_app)**: Flutter-based consumer app for session management, payments, and navigation.
*   👮 **[Officer Application](parking_officer_app)**: Flutter tool for real-time enforcement, photo-evidence collection, and zone monitoring.
*   🖥️ **[Admin Dashboard](templates/dashboard)**: Responsive web interface for regional management and financial auditing.
...
|----------|------|-------------|
| 🏗️ **[Architecture](docs/architecture.md)** | 🏭 | Infrastructure, Security, and Background Task logic. |
| 🚀 **[Features](docs/features.md)** | 🛠️ | Complete glossary of capabilities for Users, Officers, and Admins. |
| 📊 **[Diagrams](docs/diagrams.md)** | 📈 | Visual maps of system architectures and operational flows. |
| 🗄️ **[Database Schema](docs/database_schema.md)** | 🐘 | Detailed ERD and table specifications for PostgreSQL. |
| 🎨 **[Design System](docs/design_system.md)** | 🎨 | Branding tokens, Flutter glassmorphism, and web styling rules. |
| 🌐 **[i18n Guide](docs/i18n_guide.md)** | 🌍 | Instructions for maintaining translations in 5+ languages. |
| 🛠️ **[Deployment](docs/deployment_and_secrets.md)** | 🚀 | Setup guide for Docker, Render, and GitHub Actions. |
