...
class AppTheme {
  ...
  static const Color primaryColor = Color(0xFF1A2B3C); // Deep Navy
  static const Color primaryDark = Color(0xFF0F172A);
  static const Color accentColor = Color(0xFFFF8C00); // Action Orange
  static const Color successColor = Color(0xFF2ECC71); // Safety Green
