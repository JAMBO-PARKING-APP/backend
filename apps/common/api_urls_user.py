...
urlpatterns = [
    ...
    path('parking/owner/zones/<uuid:pk>/edit/', parking_views.ZoneEditAPIView.as_view(), name='zone-edit'),
    path('parking/owner/zones/<uuid:zone_id>/pricing-rules/', parking_views.PricingRuleListCreateAPIView.as_view(), name='pricing-rules'),
    path('parking/owner/pricing-rules/<uuid:pk>/', parking_views.PricingRuleDetailAPIView.as_view(), name='pricing-rule-detail'),
    path('zones/<uuid:zone_id>/current-rate/', parking_views.ZoneCurrentRateAPIView.as_view(), name='zone-current-rate'),
