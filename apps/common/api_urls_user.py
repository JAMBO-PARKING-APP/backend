...
urlpatterns = [
    ...
    path('countries/terms/', common_api_views.CountryTermsAPIView.as_view(), name='country-terms'),
    path('countries/supported/', common_api_views.CountryListAPIView.as_view(), name='supported-countries'),
    ...
    path('auth/token/refresh/', accounts_views.CustomTokenRefreshAPIView.as_view(), name='token_refresh'),
    ...
    path('payments/methods/', payments_views.PaymentMethodsListAPIView.as_view(), name='payment-methods'),
    path('payments/methods/<uuid:pk>/set-default/', payments_views.SetDefaultPaymentMethodAPIView.as_view(), 
    ...
    path('parking/applications/', parking_views.ZoneApplicationCreateAPIView.as_view(), name='zone-application'),
    path('parking/owner/zones/', parking_views.OwnerZoneListAPIView.as_view(), name='owner-zones'),
    path('parking/owner/zones/<uuid:pk>/', parking_views.OwnerZoneUpdateAPIView.as_view(), name='owner-zone-update'),
    ...
    path('payments/pesapal/prewarm/', payments_views.PesapalPreWarmView.as_view(), name='pesapal-prewarm'),
    path('payments/pesapal/token-execute/', payments_views.ExecutePesapalTokenPaymentAPIView.as_view(), name='pesapal-token-execute'),
