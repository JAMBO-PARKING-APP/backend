...
class CountryAdmin(admin.ModelAdmin):
    list_display = ('name', 'iso_code', 'phone_code', 'currency', 'is_active', 'get_payment_methods')
    list_filter = ('is_active', 'currency', 'payment_methods')
    ...
    fieldsets = (
        ('Basic Information', {
            'fields': ('name', 'iso_code', 'phone_code', 'flag_emoji', 'is_active')
        }),
        ('Location & Currency', {
            'fields': ('currency', 'currency_symbol', 'timezone', 'latitude', 'longitude')
        }),
        ('Payment Configuration', {
            'fields': ('payment_methods', 'exchange_rate_to_base'),
            'description': 'Configure available payment methods and exchange rates for this country.'
        }),
    )
